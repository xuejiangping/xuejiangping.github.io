...
() => R.effect(() => {
  ...
  const vNode = h(Fragment, b.value && {
    ...
    style: 'color:red',
    class: normalizeClass(['test_1', {
      test_2: true
    }])
  }, '测试class ,style等props绑定'), h('h2', [h(Text, '测试响应式值：' + a.value)]), h('h2', {
  ...
  h('h2', {
    ...
    class: 'test_1'
  }, b.value ? 'text1' : 'text2')]), h(Comment, '测试注释节点'), !b.value && h('h2', Array(5).fill().map((_, i) => h('div', '测试length' + i)))]);
